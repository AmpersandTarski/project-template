...
## Steps
1. Git clone https://github.com/AmpersandTarski/project-template into an empty directory, so you have all the necessary files needed to deploy your application. This is your working directory from now on, from which you run all subsequent commands.
...
5. Run `docker compose up -d --build`. This instructs docker to build and deploy your application.
6. Go to your browser and navigate to localhost to access your application.
